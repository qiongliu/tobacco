<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%" :header-cell-style="getRowClass">
      ...
      <el-table-column prop="area.name" label="推送地区"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      exportExcel() {
      Management.exportPushObjExcel().then(res => {
    ...
    deletePushObj(id) {
      Management.deletePushObj(id).then(res => {
        this.$message({
          message: "删除成功",
          type: "success"
        });
