<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%" :header-cell-style="getRowClass">
      ...
      <el-table-column prop="element" label="管理要素"></el-table-column>
      <el-table-column prop="level1" label="1级"></el-table-column>
       <el-table-column prop="level2" label="2级"></el-table-column>
        <el-table-column prop="level3" label="3级"></el-table-column>
         <el-table-column  prop="level4" label="4级">
         </el-table-column>
  ...
  methods: {
    ...
    getIndexList() {
      Management.getIndexList(
       ...
       exportExcel() {
      Management.exportIndexExcel().then(res => {
    ...
    deleteIndex(id) {
      Management.deleteIndex(id).then(res => {
        this.$message({
          message: "删除成功",
          type: "success"
        });
