<script>
  ...
  export default {
    ...
    methods: {
      _load() {
        if (!this.source && !this.XYZ.length) {
          return false;
        }
        ...
        //     url: "http://t0.tianditu.com/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=bad97986f878821411df486071340a29"
        //   }),
        //   zIndex: 1
        // });
        ...
        //   title: "天地图矢量注记图层",
        //   source: new XYZSource({
        //     url: "http://t0.tianditu.com/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=bad97986f878821411df486071340a29"
        //   })
        // });

        // this.map.addLayer(TiandiMap_vec);
        // this.map.addLayer(Tianditu_cva);
